...
exports.addCities = (req, res, next) => {
  ...
  const citiesArray = ['Alipurduar', 'Bankura', 'Basirhat', 'Birbhum', 'Coochbehar', 'Dinajpur', 'Darjeeling', 'Diamond harbour', 'Hooghly', 'Howrah', 'Jalpaiguri', 'Jhargram', 'Kalimpong', 'Malda', 'Murshidabad', 'Nadia', 'Nandigram', 'Purulia', 'Rampurhat'];
