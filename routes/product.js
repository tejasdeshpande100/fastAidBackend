...
const { createProduct, deleteProduct, getProductById, updateProduct, getProduct, getProducts, getUserProducts, listBySearch, checkForNewCities, bulkUpload, addNames, deleteProducts } = require('../controllers/product');
